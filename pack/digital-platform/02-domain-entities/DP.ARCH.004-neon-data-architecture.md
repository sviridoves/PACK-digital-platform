...
**Применённый случай — Directus (29 таблиц, 290 rows admin metadata):**
...
**Применимость паттерна:** `bot fsm_states` (state aiogram framework, см. WP-268 Блокер 1), Metabase metadata (БД #7 в DP.ARCH.004 §3.7 — отдельный решённый вопрос), Grafana/Langfuse при self-hosting.
